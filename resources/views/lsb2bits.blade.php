...
@section('title','LSB 2 bits')
@section('javascript')
    @parent
    <script>
        var analyseUrlEncode = '{{route('lsb_encode_2bits')}}';
        var analyseUrlDecode = '{{route('lsb_decode_2bits')}}';
    </script>
    <script src="{{asset('js/2bits.js')}}"></script>
    ...
    <div class="tab-content">
        <div id="encode" class="tab-pane fade in active ">
            <div class="container">
                ...
                <span data-toggle="tooltip" title="LSB алгоритм, встраивание происходит в последние 2 бита синего канала RGB, информация шифруется при помощи AES 256, происходит сдвиг от начала контейнера на указанный процент" class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                <div id="LSBEncode">
                    <div class="row">
                        <div class="col-lg-4">
                            <label>
